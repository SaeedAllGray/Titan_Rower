/* custom definitions for a timer task */

// #define configUSE_TIMERS 1
// #define configTIMER_SERVICE_TASK_NAME "Tmr Svc"
#define configTIMER_TASK_PRIORITY (configMAX_PRIORITIES - 1) // highest possible priority
#define configTIMER_TASK_STACK_DEPTH 16384
// #define configTIMER_QUEUE_LENGTH 10 // for IPC (Inter-Process Communication) between the timer task and the other tasks of the system

/* copied from ~/.platformio/packages/framework-arduinoespressif32/tools/sdk/esp32/include/freertos/include/esp_additions/freertos/FreeRTOSConfig.h */
